...
define('DB_NAME', 'ns74060_ahc_wp');

/** MySQL データベースのユーザー名 */
define('DB_USER', 'ns740_ahc_wp');

/** MySQL データベースのパスワード */
define('DB_PASSWORD', 'AhaH989_');
...
define('WP_SITEURL', 'http://www.a-h-c.jp/wp');
define('WP_HOME', 'http://www.a-h-c.jp/');
